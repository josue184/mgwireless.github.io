...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'MG Wireless', // Site Name
		applicationName: 'MG Wireless', // Site Name 
		startURL: 'http%3a//mgwireless.com/home.html', // Homepage URL 
		shortcutIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/22c6959728d147149cebf488e4066cd7/Main-mg2.ico', // Main Site Icon
		tooltip: '',

		// Dynamic jumplist tasks & notifications
		rssFeedURL: 'http://www.buildmypinnedsite.com/RSSFeed?feed=http%3a//www.mgwireless.com/rss/feed.xml',
		categoryTitle: 'Lo Nuevo en MG Wireless', // Task group name
		defaultTaskIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/99026c15c86640a482652d0f602719a5/GenericTask-mg1.ico', // Generic task icon
		
		navButtonColor: false,
		
		// Jumplist tasks { name: Task Label, action: Task URL, icon: Task Icon }
		staticTasks: [{ name: 'MG Wireless App para Android',  action: 'https%3a//play.google.com/store/apps/details?id=mgwireless.com.mgwireless', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/08380f7935cb4b25a6e6f0530976640e/Task4-mg.ico', target: 'tab' },{ name: 'Vis\u00edtanos en Facebook',  action: 'https%3a//www.facebook.com/mgwirelesstj', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/7f1924bb501c4db18f1f5c7b1ae200a0/Task2-mg.ico', target: 'tab' },{ name: 'Lo Nuevo en MG Wireless',  action: 'http%3a//www.mgwireless.com/nuevo.html%23regresar', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/34625507b44241b38829d63593f2d312/Task0-mg.ico', target: 'tab' },{ name: 'Nuestra Direcci\u00f3n',  action: 'https%3a//www.google.com/maps/dir/32.4990244,-116.9194892/32.5293111,-117.0253996/%4032.5107929,-116.9969684,13022m/data%3d!3m1!1e3!4m3!4m2!1m0!1m0?hl=es-US', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/ed0c122f5ea141bea03a1e719bee2406/Task3-mg.ico', target: 'tab' },{ name: 'Cont\u00e1ctanos hoy mismo',  action: 'http%3a//www.mgwireless.com/contacto.html%23regresar', icon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/1658d6dac3b34c9c8e92b539fbb2edec/Task1-mg.ico', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'MG Wireless' // Site name as it should appear on the pinning bar
	};
